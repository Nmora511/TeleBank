...
export default function Modal() {
  ...
  return (
    ...
    >
      <div className="bg-[var(--background)] border-[var(--primary-yellow)] border-2 rounded-md w-fit max-w-[75%] h-fit max-h-[95%] flex flex-col items-center justify-center text-center">
