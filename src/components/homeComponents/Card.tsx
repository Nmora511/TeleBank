...
export default function Card({ friend }: CardProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center cursor-pointer w-[80%] h-[26%] m-4 bg-[var(--secondary-foreground)] border-[var(--primary-yellow)] border-[0.2rem] rounded-lg">
